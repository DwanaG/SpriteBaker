...
func _on_Hide_pressed() -> void:
	...
	if visibility_state == VisibilityState.VISIBLE:
		hide.icon = preload("res://addons/sprite-baker/icons/visible.svg")
		...
		hide.icon = preload("res://addons/sprite-baker/icons/hidden.svg")
		mat = hidden_material
		...
		hide.icon = preload("res://addons/sprite-baker/icons/xray.svg")
...
func _on_Unshaded_pressed() -> void:
	...
	if shade_state == ShadeState.SHADED:
		unshaded.icon = preload("res://addons/sprite-baker/icons/shaded.svg")
		...
		unshaded.icon = preload("res://addons/sprite-baker/icons/unshaded.svg")
		...
		unshaded.icon = preload("res://addons/sprite-baker/icons/plain_color.svg")
